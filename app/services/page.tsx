        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <main className="lg:col-span-8 space-y-6">
            ...
            {loading ? (
              ...
              <div className="bg-surface-container-lowest p-10 sm:p-14 rounded-3xl border border-[#ded7ca] text-center space-y-4 shadow-sm max-w-lg mx-auto">
                <div className="w-16 h-16 rounded-3xl bg-[#f4f1ea] text-primary mx-auto flex items-center justify-center">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-on-surface-variant max-w-sm mx-auto leading-relaxed">
                    Aucun prestataire n'est publié pour l'instant. Dès que de nouveaux dossiers sont vérifiés physiquement en main propre au bureau, ils seront classés ici en temps réel.
                  </p>
                </div>
                <div className="pt-2 flex flex-wrap justify-center gap-2">
                  <Link
                    href="/devenir-prestataire"
                    className="px-5 py-2.5 rounded-2xl bg-primary hover:bg-primary-600 text-white font-bold text-xs shadow-xs transition"
                  >
                    Proposer mes services
                  </Link>
                  <a
                    href={`tel:${ADMIN_CONTACT.phone}`}
                    className="px-5 py-2.5 rounded-2xl bg-[#FAF8F5] border border-[#ded7ca] text-on-surface font-bold text-xs hover:bg-[#ede8df] transition"
                  >
                    Appeler le coordinateur
                  </a>
                </div>
              </div>
            ) : (
